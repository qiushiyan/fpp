...
### White noise {#ch9-white}

White noise is first introduced in Section \@ref(white-noise). As it turns out, the stochastic process behind a white noise is called a **pure** random process or simply white noise process. Such a process satisfies $\text{E}(y_t) = 0$, $\text{Var}(y_t) = \sigma^2$ and $\forall t \not=s, \text{Cov}(y_t, y_s) = 0$. 
